...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static final int YOLO_INPUT_SIZE = 320;
    ...
    private List<Classifier.Recognition> mappedRecognitions =
            new LinkedList<>();
    private SqueezeNcnn squeezencn=new SqueezeNcnn();
    @Override
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        detector = TensorFlowYoloDetector.create(
                getAssets(),squeezencn, YOLO_INPUT_SIZE, YOLO_BLOCK_SIZE);
        ...
        detectionOverlay = (OverlayView) findViewById(R.id.detection_overlay);
