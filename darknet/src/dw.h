...
template <bool kAllowStrided, int kFixedInputDepth, int kFixedDepthMultiplier>struct FloatDepthwiseConvKernel {};
...
extern "C" void FloatDepthwiseConvAccumRow(int stride, int input_depth, int input_width,
...
// Initializes the accumulator buffer with bias values.
        ...
        template <FusedActivationFunctionType Ac> void DepthwiseConv(const float* input_data, const Dims<4>& input_dims,
